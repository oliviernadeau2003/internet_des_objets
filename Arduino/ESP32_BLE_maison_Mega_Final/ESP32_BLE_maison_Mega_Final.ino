...
const char* nomBLE = "15-ESP32";  //Votre identifiant UNIQUE correspond à votre numéro du HM-10 BLE et par conséquent votre ESP32
...
static BLEUUID serviceUUID("FF15");  //remplacer le UUID par FFXX où XX est le numéro du HM10
...
std::string myDeviceName = "15-HM10-IDO";  //ÉCRIRE ICI le nom de votre HM-10, donc remplacer 00 par votre numéro
...
EspMQTTClient client(
  "CSTJ-UBI-D139",
  "$$12345678",
  "192.168.138.104",  // Adresse IP du serveur (broker) MQTT
